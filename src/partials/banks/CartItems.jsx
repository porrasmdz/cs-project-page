    ...
    <>
      <ul>
        ...
        <li className="sm:flex items-center py-6 border-b border-slate-200">
          ...
          <div className="grow">
            <a href="#0">
              <h3 className="text-lg font-semibold text-slate-800 mb-1">Fundación La Casa de Cristo</h3>
            </a>
            ...
            <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="flex flex-wrap items-center space-x-2 mr-2">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">A 2.3kms</div>
                </div>
              </div>
              <button className="text-sm underline hover:no-underline">Ver Más</button>
            </div>
          </div>
        </li>
        {/* Cart item */}
        <li className="sm:flex items-center py-6 border-b border-slate-200">
          ...
          <div className="grow">
            <a href="#0">
              <h3 className="text-lg font-semibold text-slate-800 mb-1">Fundación Cristo Rey</h3>
            </a>
            <div className="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</div>
            {/* Product meta */}
            <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="flex flex-wrap items-center space-x-2 mr-2">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">A 3.2kms</div>
                </div>
              </div>
              <button className="text-sm underline hover:no-underline">Ver Más</button>
            </div>
        ...
        <li className="sm:flex items-center py-6 border-b border-slate-200">
          ...
          <div className="grow">
            <a href="#0">
              <h3 className="text-lg font-semibold text-slate-800 mb-1">Fundación Los Retribuyentes</h3>
            </a>
            <div className="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</div>
            {/* Product meta */}
            <div className="flex flex-wrap justify-between items-center">
              ...
              <div className="flex flex-wrap items-center space-x-2 mr-2">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">A 1.2kms</div>
                </div>
              </div>
              <button className="text-sm underline hover:no-underline">Ver Más</button>
            </div>
