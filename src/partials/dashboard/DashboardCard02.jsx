  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mb-2">Total de Personas Ayudads</h2>
        <div className="text-xs font-semibold text-slate-400 uppercase mb-1">Hasta el 20/02/24</div>
